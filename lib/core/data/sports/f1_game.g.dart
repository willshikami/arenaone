...
F1Game _$F1GameFromJson(Map<String, dynamic> json) => F1Game(
  ...
  p4Name: json['p4Name'] as String?,
  p4Team: json['p4Team'] as String?,
  p4Image: json['p4Image'] as String?,
  p4Points: json['p4Points'] as String?,
  p4Gap: json['p4Gap'] as String?,
...
Map<String, dynamic> _$F1GameToJson(F1Game instance) => <String, dynamic>{
  ...
  'p4Name': instance.p4Name,
  'p4Team': instance.p4Team,
  'p4Image': instance.p4Image,
  'p4Points': instance.p4Points,
  'p4Gap': instance.p4Gap,
